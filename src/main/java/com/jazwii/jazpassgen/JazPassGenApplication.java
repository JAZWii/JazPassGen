package com.jazwii.jazpassgen;

import com.jazwii.jazpassgen.Entity.Repository.CustomRepositoryImpl;
...
public class JazPassGenApplication {

    public static void main(String[] args) {
        SpringApplication.run(JazPassGenApplication.class, args);
    }
